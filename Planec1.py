...
if __name__ == '__main__':
    ...
    movingobjects= [MovingObject(pshape, (0,0,-.1), vec4(0,0,0,0), Material())]
    ...
    t_start= time.time()
    frames= 250
    for shot_time, frame_count in np.linspace([0,1],[20,frames], frames):
        ...
        filename= ".\\render7\\%i.png" % frame_count
