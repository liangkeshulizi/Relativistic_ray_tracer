...
if __name__ == '__main__':
    (width, height) = (1920*2, 1080*2)      # 屏幕尺寸
    ...
    movingobjects= [MovingObject(pshape, (0,0,-.6), vec4(0,0,0,0), Material())]
    ...
    t_start= time.time()
    frames= 250
    for shot_time, frame_count in np.linspace([0,1],[3,frames], frames):
