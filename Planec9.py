...
if __name__ == '__main__':
    ...
    pshape = Plane(vec3(0,0,1.5), vec3(0,0,-1), diffuse_color_function= get_cubical_checkerboard_color_func(BILIBILIBLUE, WHITE))

    movingobjects= [MovingObject(pshape, (0,0,-.9), vec4(0,0,0,0), Material())]
    ...
    t_start= time.time()
    frames= 300
    for shot_time, frame_count in np.linspace([0.5,1],[2.5,frames], frames):
        ...
        filename= ".\\render6\\%i.png" % frame_count
