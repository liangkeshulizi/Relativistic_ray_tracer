...
if __name__ == '__main__':
    ...
    fshape = Plane(vec3(0,0,1.5), vec3(0,0,-1), range_func_from_image(r'E:\视频\特勒尔效应\素材\bilibili_tv.png', (2,2)), lambda p: BILIBILIPINK)
    bgshape = Plane(vec3(0,0,1.5), vec3(0,0,-1), range_func_from_image(r'E:\视频\特勒尔效应\素材\bilibili_tv.png', (2,2)), lambda p: rgb(0.3,0.3,0.3))

    movingobjects= SqueezeMovingobjects(fshape, bgshape, (0,0,-.6), vec4(0,0,0,0), 0.05, 100)
    ...
    t_start= time.time()
    frames= 250
    for shot_time, frame_count in np.linspace([1,1],[2.3,frames], frames):
